...
ErrorStatus OV7725_Init(void)
{
	...
	LCD_DrawString(100, 0, "ov7725 Register Config Start......");
	...
	LCD_DrawString(100, 50, "ov7725 Register Config Success");
...
void OV7725_Window_VGA_Set(uint16_t sx, uint16_t sy, uint16_t width, uint16_t height)
{
	...
	/***************HSIZE*********************/
	SCCB_WriteByte(REG_HSIZE, width >> 2); //HSIZE 320
	...
	/***************VSIZE*********************/
	SCCB_WriteByte(REG_VSIZE, height >> 1); //VSIZE 240
